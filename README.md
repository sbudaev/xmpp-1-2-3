...
This is an example configuration for ejabberd XMPP server.
...
For details see [https://budaev.info/xmpp-server-on-1-2-3.html](https://budaev.info/xmpp-server-on-1-2-3.html)
